...
<body>
  ...
  document.addEventListener('DOMContentLoaded', () => {
     ...
     * ------------------------- */
    const questions = [
      { text:"Which platform does this module cover right now?", choices:["macOS","Windows","Kasm (browser workspace)"], correct:0, explanation:"This track is macOS-only." },
      { text:"Which app do you open to run setup commands?", choices:["Terminal","Finder","System Settings","Safari"], correct:0, explanation:"All shell commands run in Terminal." },
      { text:"Which command prints your current working directory?", choices:["pwd","ls","cd ..","whoami"], correct:0, explanation:"Use <code>pwd</code> to show the current directory path." },
      { text:"Create a folder for course work named <code>ocnpcs</code>. Which command is correct?", choices:["mkdir ocnpcs","mk ocnpcs","newdir ocnpcs","touch ocnpcs"], correct:0, explanation:"<code>mkdir NAME</code> makes a directory." },
      { text:"Move into that new folder. Which command is correct?", choices:["cd ocnpcs","open ocnpcs","ls ocnpcs","cat ocnpcs"], correct:0, explanation:"<code>cd</code> changes directories." },
      { text:"Confirm Git is installed. What should succeed?", choices:["git --version","git --install","git version install","brew git version"], correct:0, explanation:"<code>git --version</code> prints the installed version." },
      { text:"Clone the classroom repo to your <code>ocnpcs</code> folder. Which command is correct?", choices:["git clone https://github.com/Open-Coding-Society/student.git","git pull https://github.com/Open-Coding-Society/student.git","git download Open-Coding-Society/student","clone git Open-Coding-Society/student"], correct:0, explanation:"Use <code>git clone &lt;URL&gt;</code> to copy a repo." },
      { text:"Move into the cloned repo directory. Which command is correct?", choices:["cd student","cd Open-Coding-Society","cd ..","open student ."], correct:0, explanation:"The repo directory is named <code>student</code>." },
      { text:"How should you run the upcoming script commands?", choices:["One line at a time in Terminal","Paste them all at once","Run them in Finder","Double-click the .sh files"], correct:0, explanation:"Run commands individually to see errors and prompts." },
      { text:"Run the macOS prerequisites script from the repo. Which command is correct?", choices:["./scripts/activate_macos.sh","bash scripts/activate_mac.sh","source activate_macos","run activate_macos.sh"], correct:0, explanation:"Execute the macOS prerequisites helper script." },
      { text:"Run the script that prompts for your Git UID and Personal Email.", choices:["./scripts/activate.sh","git config --global --prompt","./scripts/git_setup.sh","git init --email"], correct:0, explanation:"This script collects your identity and sets global config." },
      { text:"Create your Python virtual environment from the repo helper. Which command is correct?", choices:["./scripts/venv.sh","python -m venv .","pip install venv","virtualenv activate"], correct:0, explanation:"Use the provided helper to create the venv consistently." },
      { text:"Which command verifies Python is available?", choices:["python --version","pip --python","python --install","py --v"], correct:0, explanation:"<code>python --version</code> prints the Python version." },
      { text:"Which command verifies pip is available?", choices:["pip --version","pip install --version","python --pip","brew pip --version"], correct:0, explanation:"<code>pip --version</code> confirms pip is installed." },
      { text:"Which command prints your Ruby version?", choices:["ruby -v","ruby --about","gem -v","bundler --ruby"], correct:0, explanation:"<code>ruby -v</code> shows the Ruby version." },
      { text:"Which command prints your Bundler (Ruby) version?", choices:["bundler -v","bundle version show","ruby --bundler","gem bundler -v"], correct:0, explanation:"<code>bundler -v</code> reports Bundler's version." },
      { text:"Which command prints your RubyGems version?", choices:["gem --version","gen --version","gems -v","ruby --gems"], correct:0, explanation:"<code>gem --version</code> shows the RubyGems version." },
      { text:"After running <code>git config --global --list</code>, which indicates identity is set correctly?", choices:["Entries including user.name and user.email","Only core.autocrlf","An empty output","remote.origin.url only"], correct:0, explanation:"You should see both <code>user.name</code> and <code>user.email</code>." },
      { text:"From the repo directory, open the folder in VS Code. Which command is correct?", choices:["code .","open .code","vscode ./","open code"], correct:0, explanation:"<code>code .</code> opens the current folder in VS Code." },
      { text:"Each time you start a new Terminal session to work, which sequence is correct?", choices:["cd ocnpcs/student → source venv/bin/activate → code .","source venv/bin/activate → cd ocnpcs/student → code .","code . → cd ocnpcs/student → source venv/bin/activate","open student → activate venv → code"], correct:0, explanation:"Enter the repo, activate venv, then open in VS Code." },
